...
// function Home(props){
  // const portfolioFiltersDiv = useRef(null);
  // const all = useRef(null);
  // const jsApps = useRef(null);
  // const cSharpApps = useRef(null);
  ...
  //   useLayoutEffect(() => {
  //     console.log('useEffect for isotopes was called')
  //     if ({projects} != null){
  ...
  //       }
  //     // });
  //         setIsotopesLoaded(true);
  //         console.log('loaded Isotopes.');
  //     }
  // })
...
//WORKING
  ...
  //   console.log('Setting mapping to finished.');
  // }


  // {console.log('mapping projects in return: ' + projects.map)}



  // const getProjects = () => {
  //   console.log('getProjects was called.')
  //   if (setProjects === null){
  //     const mappedProjects = props.projList.map((project) => {
  //       <Project
  //       whenProjClicked = { props.onProjSelection }
  //       name={project.name}
  //       image={project.image}
  ...
  //     console.log(' and elements were mapped/returned?');
  //   }
  // }
          ...
          <div id="portfolio" className="paddsection">
            ...
            <div className="container">
              ...
              className="row portfolio-container">
                ...
                {/* {allProjectsMapFunc()}
                {setMapFinish()} */}
                {/* {!isotopesLoaded ? props.projList.map((project) => {
                  <Project
                  whenProjClicked = { props.onProjSelection }
                  name={project.name}
                  image={project.image}
                ...
                {/* {!isotopesLoaded ?  console.log('mapping projects') : console.log('skipped mapping')} */}
                {/* {!isotopesLoaded ? getProjects() : [projects]} */}
                {/*{!isotopesLoaded ? loadIsotopes() : null} */}
                ...
                {/* {console.log('mapProjects in return/render should be above this?')} */}
                ...
                {/* {projects.map ? setFinishedMapping(true) : setFinishedMapping(false)} */}
